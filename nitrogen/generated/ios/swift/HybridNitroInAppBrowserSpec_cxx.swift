 ...
 */
open class HybridNitroInAppBrowserSpec_cxx {
  /**
   * The Swift <> C++ bridge's namespace (`margelo::nitro::nitroinappbrowser::bridge::swift`)
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridNitroInAppBrowserSpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridNitroInAppBrowserSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridNitroInAppBrowserSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridNitroInAppBrowserSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridNitroInAppBrowserSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridNitroInAppBrowserSpec_cxx) -> Bool {
  ...
  public final func open(url: std.string, options: bridge.std__optional_NitroInAppBrowserOptions_) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.open(url: String(url), options: options.value)
