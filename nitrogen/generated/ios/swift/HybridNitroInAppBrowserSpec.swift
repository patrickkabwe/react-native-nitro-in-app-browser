...
public extension HybridNitroInAppBrowserSpec_protocol {
...
open class HybridNitroInAppBrowserSpec_base {
  ...
  public func getCxxWrapper() -> HybridNitroInAppBrowserSpec_cxx {
  #if DEBUG
    guard self is any HybridNitroInAppBrowserSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridNitroInAppBrowserSpec_cxx(self as! any HybridNitroInAppBrowserSpec)
